...
| =, ≠                                  | both operands of the same type (any type) <br> _unknown_ if at least one operand is _null_ <br> Exceptions for _float_: <br>
(NaN = _null_) = _false_; (NaN ≠ _null_) = _true_
