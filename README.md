...
| <, >, ≤, ≥                            | both operands of the same ordinal type: <br> _int_ / _float_ / _date_ / _datetime_ / _duration_ / _string_ / other ordinal <br> _unknown_ if at least one operand is _null_. <br> Exceptions for _string_: <br> ("" ≤ _null_) = (_null_ ≥ "") = _true_ <br> (""  > _null_) = (_null_ < "") = _false_ <br> (""  > _null_) = (_null_ < "") = _false_ <br> Exceptions for bounded types with non NaN value: <br> (_lb_ ≤ _null_) = (_null_ ≥ _lb_) = (_ub_ ≥ _null_) = (_null_ ≤ _ub_) = _true_ <br> (_ub_ < _null_) = (_null_ > _ub_) = (_lb_ > _null_) = (_null_ < _lb_) = _false_ <br> where _lb_ is the lower bound (e.g., INT_MIN for _integer_) and _hb_ is the upper bound (e.g., INT_MAX for _integer_)
